...
<Text style={styles.title1} >Hotel La Casa de Mamapan</Text>
<ScrollView>
          <ScrollView horizontal>
                ...
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/occidente/oc6.jpg')} />
                </View>
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/occidente/oc7.jpg')} />
                </View>
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/occidente/oc8.jpg')} />
                </View>
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/occidente/oc9.jpg')} />
                </View>
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/occidente/oc10.jpg')} />
                </View>
                </ScrollView>
         <Text></Text>
         <Text></Text>       
