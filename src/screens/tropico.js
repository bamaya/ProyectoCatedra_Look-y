...
<Text style={styles.title1} >Hotel Tropico Inn</Text>
<ScrollView>
          <ScrollView horizontal>
                ...
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/oriental/ori1.jpg')} />
                </View>
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/oriental/ori2.png')} />
                </View>
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/oriental/ori3.jpg')} />
                </View>
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/oriental/ori4.png')} />
                </View>
                </ScrollView>
         <Text></Text>
         <Text></Text> 
