...
<Text style={styles.title1} >Hotel Casa Verde</Text>
<ScrollView>
          <ScrollView horizontal>
                ...
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/occidente/oc2.jpg')} />
                </View>
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/occidente/oc3.webp')} />
                </View>
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/occidente/oc4.jpg')} />
                </View>
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/occidente/oc5.jpg')} />
                </View>
                </ScrollView>
         <Text></Text>
         <Text></Text>       
