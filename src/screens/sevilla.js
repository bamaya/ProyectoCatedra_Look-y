...
<Text style={styles.title1} >Hotel Sevilla</Text>
<ScrollView>
          <ScrollView horizontal>
                ...
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/oriental/ori5.png')} />
                </View>
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/oriental/ori6.jpg')} />
                </View>
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/oriental/ori7.png')} />
                </View>
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/oriental/ori8.jpg')} />
                </View>
                </ScrollView>
         <Text></Text>
         <Text></Text>       
