...
<Text style={styles.title1} >Hotel Argueta</Text>
<ScrollView>
          <ScrollView horizontal>
                ...
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/central/ce6.jpg')} />
                </View>
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/central/ce7.webp')} />
                </View>
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/central/ce8.jpg')} />
                </View>
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/central/ce9.webp')} />
                </View>
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/central/ce10.jpg')} />
                </View>
                </ScrollView>
         <Text></Text>
         <Text></Text>       
