...
<Text style={styles.title1} >Hotel Comfort Inn Real</Text>
<ScrollView>
          <ScrollView horizontal>
                ...
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/oriental/ori9.jpg')} />
                </View>
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/oriental/ori10.jpg')} />
                </View>
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/oriental/ori11.jpg')} />
                </View>
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/oriental/ori12.jpg')} />
                </View>
                </ScrollView>
         <Text></Text>
         <Text></Text>       
