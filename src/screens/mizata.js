...
<Text style={styles.title1} >Hotel Mizata Point Resort</Text>
<ScrollView>
          <ScrollView horizontal>
                ...
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/occidente/oc11.jpg')} />
                </View>
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/occidente/oc12.webp')} />
                </View>
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/occidente/oc13.jpg')} />
                </View>
                <View>
                    <Image
                        style={styles.ciudad}
                        source={require('../img/occidente/oc14.jpg')} />
                </View>
